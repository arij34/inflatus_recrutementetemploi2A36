            ...
            <ul class="nav">
              ...
              <div>
                  <i class="fa fa-circle" aria-hidden="true" style="color: green; font-size: 10px;"> </i> 
                    Bienvenue <?php echo $nomEntreprise; ?>
                </div>
            </ul>        
        ...
        <div class="row">
          <div class="col-lg-6 offset-lg-3">
                <center><div class="main-blue-button">
                   <a href="../offre_test/addDomaine.php">Ajouter un domaine </a>
                </div></center>
            ...
            <a href="#">
              <div class="item wow bounceInUp" data-wow-duration="1s" data-wow-delay="0.3s">
                ...
                <div class="showed-content text-center">
                    <img src="../offre_test/assets/images/développement mobile.png" alt="Description de l'image">
                </div>
            </div>
            ...
            <a href="#">
              <div class="item wow bounceInUp" data-wow-duration="1s" data-wow-delay="0.4s">
                ...
                <div class="showed-content">
                    <img src="../offre_test/assets/images/développement web.png" alt="Description de l'image">
                </div>
            </div>
          ...
          <div class="col-lg-3 col-sm-6">
            <a href="#">
              <div class="item wow bounceInUp" data-wow-duration="1s" data-wow-delay="0.5s">
                ...
                <div class="showed-content text-center">
                    <img src="../offre_test/assets/images/securité de l'informatique.png" alt="Description de l'image">
                </div>
            </div>
          ...
          <div class="col-lg-3 col-sm-6">
            <a href="#">
              <div class="item wow bounceInUp" data-wow-duration="1s" data-wow-delay="0.6s">
                ...
                <div class="showed-content">
                    <img src="../offre_test/assets/images/science de l'informatique.png" alt="Description de l'image">
                </div>
            </div>
        ...
        <div class="row">
          <div class="col-lg-12">
            <div class="row">
                  ...
                  <fieldset>
                    <div style="display: flex; justify-content: center;">
                      <div class="main-blue-button" style="margin-right: 10px;">
                        <a href="../offre_test/profilEntrepriseO.php?idE=<?php echo $idE; ?>">Voir tous les Offres</a>
                      </div>
                      <div class="main-blue-button">
                         <a href="../offre_test/addOffre.php?idE=<?php echo $idE; ?>">Ajouter une offre</a>
                     </div>
                   </div>
                  </fieldset>
              ...
              <div class="col-lg-6">
                <div class="right-image wow fadeInRight" data-wow-duration="1s" data-wow-delay="0.5s">
                  <img src="../offre_test/assets/images/Job hunt-cuate.png" alt="team meeting">
                </div>
              </div>
            </div>
          </div>
      ...
      <div class="row">
        <div class="col-lg-6 align-self-center  wow fadeInLeft" data-wow-duration="1s" data-wow-delay="0.2s">
          <div class="left-image">
            <img src="../offre_test/assets/images/services-left-image.png" alt="">
          </div>
        </div>
