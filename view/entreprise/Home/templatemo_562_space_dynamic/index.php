        ...
        <div class="col-12">
          <nav class="main-nav">
            ...
            <ul class="nav">
              ...
              <li class="scroll-to-section"><a href="#services">Evénement</a></li>
              ...
              <li class="scroll-to-section"><a href="http://localhost/web/gestionUser/view/entreprise/afficherProfil.php" class="active">Profile</a></li> 
