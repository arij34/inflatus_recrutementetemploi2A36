...
include 'C:/xampp/htdocs/web/gestionUser/controller/EntrepriseC.php';
    ...
    if(isset($_POST["email"])) {
        ...
        try {
            ...
            $mail->Body    = 'Voici votre lien pour modifier votre mot de passe : <a href="http://localhost/web/gestionUser/view/entreprise/forgetPass/reset.php">Cliquez ici</a>';
            $mail->AltBody = 'Vous avez eu de problème pour charger le formulaire.';

            // Envoi de l'e-mail
            if($mail->send()) {
                // Redirection après l'envoi de l'e-mail
                header('Location:http://localhost/web/gestionUser/view/entreprise/forgetPass/mailenvoyee.html');
                exit();
            } else {
