...
<head>
    ...
    <title>Gestion Blog | Remplir</title>
    <!-- BOXICONS -->
    ...
    <!-- STYLE -->
    <link rel="stylesheet" href="/assetsgb/css/style.css">
    <link href="vendor/bootstrap/css/bootstrap.min.css" rel="stylesheet">
    <!-- Additional CSS Files -->
    <link rel="stylesheet" href="../reclam_blog/assetsgb/css/fontawesome.css">
    <link rel="stylesheet" href="../reclam_blog/assetsgb/css/templatemo-space-dynamic.css">
    <link rel="stylesheet" href="../reclam_blog/assetsgb/css/animated.css">
    <link rel="stylesheet" href="../reclam_blog/assetsgb/css/owl.css">
    <style>
                    ...
                    <div class="col-12">
                        <nav class="main-nav">
                            ...
                            <a href="acceuil.html" class="logo">
                                <h4>
                                    <div class="corner-container">
                                        <img src="../reclam_blog/assetsgb/images/logo.png">
                                    </div>
                            ...
                            <ul class="nav">
                                ...
                                <li class="scroll-to-section"><a href="home.php">Blog</a></li>
        ...
        width: 100%;
            ...
            <div class="col col-1">
                <div class="image-layer">
                    ...
                    <img src="../reclam_blog/assetsgb/img/about-left-image.png" class="form-image-main">

                    <img src="../reclam_blog/assetsgb/img/cloud.png" class="form-image cloud">
                    <img src="../reclam_blog/assetsgb/img/stars.png" class="form-image stars">
                </div>
            ...
            <div class="col col-2">
                <div class="login-form">
                    <div class="form-title">
                        <span>Remplir votre Blog</span>
                    </div>
                    <form action="../reclam_blog/AddPost.php" method="post" enctype="multipart/form-data" onsubmit="return validerForm()">
<table>
    <tr>
    ...
    <tr>
        <td><input type="submit" value="Submit" style="background-color: #3498db; color: white; border: none; padding: 10px 20px; border-radius: 5px; cursor: pointer;"></td>
        <td><input type="reset" value="Reset"style="background-color: #3498db; color: white; border: none; padding: 10px 20px; border-radius: 5px; cursor: pointer;"></td>
    </tr>
</table>
</form>
                </div>
        ...
        <!-- JS -->
        <script src="../reclam_blog/assetsgbgb/js/main.js"></script>
        <script src="../reclam_blog/assetsgb/js/validation.js"></script>
        <script src="../reclam_blog/vendor/jquery/jquery.min.js"></script>
        <script src="../reclam_blog/vendor/bootstrap/js/bootstrap.bundle.min.js"></script>
        <script src="../reclam_blog/assetsgb/js/owl-carousel.js"></script>
        <script src="../reclam_blog/assetsgb/js/animation.js"></script>
        <script src="../reclam_blog/assetsgb/js/imagesloaded.js"></script>
        <script src="../reclam_blog/assetsgb/js/templatemo-custom.js"></script>
