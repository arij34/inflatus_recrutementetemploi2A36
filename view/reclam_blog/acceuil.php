...
<style>
  #form-submit {
      display: block; /* Permet au bouton de prendre toute la largeur disponible */
      ...
      <div class="row">
        ...
        <div class="col-lg-6 wow fadeInRight" data-wow-duration="0.5s" data-wow-delay="0.25s">
         ...
         // Ajouter le lien vers addEvenement.php avec l'ID de l'entreprise
          $idEtudiant =3 ; // Remplacez 1 par l'ID de l'entreprise
          echo "<a href='reclame.php?idEtudiant=$idEtudiant' class='btn btn-primary' style='font-weight: bold; font-size: 18px; width:200px;'>remplir reclamation</a>";
           ?>
              </div>
            </div>
