...
<div id="main-wrapper">   
    ...
    <div class="content-body">
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-6">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title">Statistiques des offres par domaine</h4>
                            <div class="graphBox" style="width: 500px; height: 500px;">
                                <canvas id="graphiqueOffresParDomaine" width="400" height="400"></canvas>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <script>
            var ctx = document.getElementById('graphiqueOffresParDomaine').getContext('2d');
        ...
        <div class="footer">
            <div class="copyright">
                <p>Copyright &copy; Designed & Developed by KHADAMNI 2024</p>
            </div>
        </div>
    </div>
</div>
