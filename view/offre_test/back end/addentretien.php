...
<body>
    ...
    <div id="main-wrapper">   
        ...
        <div class="content-body">
            ...
            <form action="" method="POST" name="myForm" onsubmit="return validateForm()">
                ...
                <div class="input-box">
                        <input type="text" class="input-field" placeholder="ID test" name="id_test" required>
                    </div>
                <div class="input-box">
                        <input type="email" class="input-field" placeholder="Email" name="email_test" required>
                    </div> 
                    <div class="input-box">
                        <input type="text" class="input-field" placeholder="Nom" name="nom_entre" required>
                        <input type="text" class="input-field" placeholder="Prenom" name="prenom_entre" required>
                    </div>
                    <div class="input-box">
                        <input type="text" class="input-field" placeholder="Nom Entreprise" name="nom_entreprise_test" required>
                    </div>
                    <div class="input-box">
                        <input type="date" class="input-field" placeholder="Date d'entretien'" name="date_entre" required>
                    </div> 
                    <div class="input-box">
                        <input type="text" class="input-field" placeholder="Type d'entretien" name="type_entre" required>
                    </div>      
                    <div class="input-box">
    ...
    <script>
        function validateForm() {
            var id_test = document.forms["myForm"]["id_test"].value;
            var email_test = document.forms["myForm"]["email_test"].value;
            var nom_entre = document.forms["myForm"]["nom_entre"].value;
            var prenom_entre = document.forms["myForm"]["prenom_entre"].value;
            var nom_entreprise_test = document.forms["myForm"]["nom_entreprise_test"].value;
            var date_entre = document.forms["myForm"]["date_entre"].value;
            var type_entre = document.forms["myForm"]["type_entre"].value;
             

            if (id_test == "" ||email_test == "" || nom_entre == "" || prenom_entre == "" || nom_entreprise_test == "" || date_entre== ""  || type_entre == ""  ) {
