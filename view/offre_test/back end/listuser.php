        ...
        <div class="nk-sidebar">  
            ...
            <div class="nk-nav-scroll">
                <ul class="metismenu" id="menu">
                    ...
                    <li>
                        <a class="has-arrow" href="javascript:void()" aria-expanded="false">
                            <i class="icon-menu menu-icon"></i><span class="nav-text">Gestion Entretien </span>
                        </a>
                        <ul aria-expanded="false">
                            <li><a href="table-basic.php" aria-expanded="false">Tableaux</a></li>
                        </ul>
                    </li>
                    <li>
                        <a class="has-arrow" href="javascript:void()" aria-expanded="false">
                            <i class="icon-menu menu-icon"></i><span class="nav-text">Gestion Offres&Demandes </span>
                        </a>
                        <ul aria-expanded="false">
                            <li><a href="table-basicOffre.php" aria-expanded="false">Tableaux</a></li>
                        </ul>
                    </li>
                    <li>
                        <a class="has-arrow" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="./chart-flot.php">Gestion Demandes</a></li>
                        </ul>
                        <ul aria-expanded="false">
                            <li><a href="./chart-flotOffres.php">Gestion Offres</a></li>
                        </ul>
                    </li>
                </ul>
            </div>
