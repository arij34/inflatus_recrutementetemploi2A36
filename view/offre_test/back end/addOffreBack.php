    ...
    <div class="content">
        <header class="header-area header-sticky wow slideInDown" data-wow-duration="0.75s" data-wow-delay="0s">
            <div class="container">
              <div class="row">
                <div class="col-12">
                  <nav class="main-nav">
                    ...
                    <ul class="nav">
              <li class="scroll-to-section"><a href="http://localhost/web/view/admin/afficher.php" >Acceuil</a></li>
              ...
              <li class="scroll-to-section"><a href="http://localhost/web/view/admin/profil.php" class="active">Profile</a></li> 
              <li class="scroll-to-section"><a href="http://localhost/web/view/admin/profil.php" class="active"></a></li> 
...
@media (max-width: 892px) {
    ...
    return true;
         ...
         <form  name="monFormulaire" method="POST" action="" onsubmit="return validateForm()">   
            ...
            <div class="form-inputs">
                <div class="input-box">
                    <input type="hidden" class="input-field" placeholder="id_o" >
                </div>
            </div>
            <div class="form-inputs">
                <div class="input-box">
    ...
    <input type="text" class="input-field" placeholder="idE" name="idE" >
</div>
            </div>
            <div class="form-inputs">
                <div class="input-box">
