        ...
        <div class="content-body">
            ...
            ?>
                ...
                <div class="form-inputs">
                    <div class="input-box">
                        <input type="text" name="idEvenement" id="idEvenement" class="input-field" value="<?php echo $Evenement['idEvenement']; ?>" >
                        ...
                        <input type="text" name="idE" id="idE" class="input-field"value="<?php echo $Evenement['idE']; ?>" >
