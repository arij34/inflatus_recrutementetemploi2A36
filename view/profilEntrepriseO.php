<?php
require_once 'C:\xampp\htdocs\integfy\controller\OffreC.php'; // Assurez-vous que ce chemin est correct
                                    ...
                                    <table class="table table-bordered table-striped verticle-middle" style="width: 100%;">
                                        <thead>
                                            <tr>
                                                ...
                                                <th scope="col">Annuler l'offre</th>
                                                <th scope="col">Modifier l' offre</th>
