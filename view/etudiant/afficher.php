                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="card" style="width: 1000px; left: 10%; top: 2%">
                            ...
                            <div class="card-body" >
                                <h4 class="card-title">Tableau Etudiant</h4>
                                        ...
                                        <table class="table table-xs mb-0">
                                            ...
                                            <tbody>
                                                <?php foreach ($users as $user) : ?>
                                                    <tr>
                                                        <td class="text-center"><?= isset($user['idEtudiant']) ? $user['idEtudiant'] : ''; ?></td>
                                                        <td><?= isset($user['nomE']) ? $user['nomE'] : ''; ?></td>
                                                        <td><?= isset($user['prenomE']) ? $user['prenomE'] : ''; ?></td>
                                                        <td><?= isset($user['telephoneE']) ? $user['telephoneE'] : ''; ?></td>
                                                        <td><?= isset($user['age']) ? $user['age'] : ''; ?></td>
                                                        <td><?= isset($user['emailE']) ? $user['emailE'] : ''; ?></td>
                                                        <td><?= isset($user['MDPE']) ? $user['MDPE'] : ''; ?></td>
                                                        ...
                                                        <td class="text-center">
                                                            ...
                                                            <form method="POST" action="http://localhost/web/gestionUser/view/etudiant/modifier.php">
                                                                ...
                                                                <input type="hidden" value="<?= isset($user['idEtudiant']) ? $user['idEtudiant'] : ''; ?>" name="idEtudiant">
                                                            </form>
                                                        ...
                                                        <td  class="text-center">
                                                            <a href="updateUserBlockActive.php?idEtudiant=<?= isset($user['idEtudiant']) ? $user['idEtudiant'] : ''; ?>" >
                                                                <button  class="btn btn-danger btn-sm btn-icon" >   
                                                                    <i class="fa fa-window-close" aria-hidden="true"> blocker</i>
                                                                </button> 
                                                            </a>
                                                            <a href="updateUserBlockdesactive.php?idEtudiant=<?= isset($user['idEtudiant']) ? $user['idEtudiant'] : ''; ?>" >
                                                                <button class="btn btn-success btn-sm btn-icon" >   
                                                                    <i class="fa fa-check-square" aria-hidden="true"> deblocker</i>
                                                                </button> 
                                                            </a>
