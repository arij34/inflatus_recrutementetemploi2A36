...
// Récupération de la liste des Evenements depuis la base de données
        ...
        <div class="row">
            <div class="col-lg-6 offset-lg-3">
                <div class="section-heading  wow bounceIn" data-wow-duration="1s" data-wow-delay="0.2s">
                    <h2>Découvrir <em> la liste </em>  <span>des Evenements</span></h2>
                </div>
            </div>
        </div>
        <div class="row">
            ...
            <a href="#">
                <div class="item wow bounceInUp" data-wow-duration="1s" data-wow-delay="0.3s">
                     <div class="hidden-content scroll-text">
                        <h4><?php echo $evenement['nomEvenement']; ?></h4>
                        <p><?php echo $evenement['adresseEVN']; ?></p>
                        <p><?php echo $evenement['dateEVN']; ?></p>
                        <!-- Bouton "Détails" -->
                     </div>
                     <div class="showed-content"></div>
