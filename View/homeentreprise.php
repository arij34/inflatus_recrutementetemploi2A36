         ...
         <div class="col-lg-3 col-sm-6">
            <a href="#">
                <div class="item wow bounceInUp" data-wow-duration="1s" data-wow-delay="0.3s">
                     ...
                     <a href="detail.php?id=<?php echo $entreprise['idEntreprise']; ?>">
                      <img src="templatemo_562_space_dynamic/assets/images/<?php echo $entreprise['cheminImage']; ?>" alt="<?php echo $entreprise['idEntreprise']; ?>">
                     </a>
