                        ...
                        <table class="table table-bordered table-striped verticle-middle" style="width: 100%;">
                            <thead>
                                <tr>
                                    ...
                                    <th scope="col">Identifiant catégorie</th>
                                    <th scope="col">cheminImage</th>
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        <td><?php echo $entreprise['idEntreprise']; ?></td>
                                        <td><?php echo $entreprise['nomEntreprise']; ?></td>
                                        <td><?php echo $entreprise['adresse']; ?></td>
                                        <td><?php echo $entreprise['telephone1']; ?></td>
                                        <td><?php echo $entreprise['telephone2']; ?></td>
                                        <td><?php echo $entreprise['email']; ?></td>
                                        <td><?php echo $entreprise['dateCreation']; ?></td>
                                        <td><?php echo $entreprise['idCategorie']; ?></td>
                                        <td><?php echo $entreprise['cheminImage']; ?></td>
