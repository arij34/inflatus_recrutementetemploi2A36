        ...
        <div class="content-body">
            ...
            <form action="" method="POST" name="myForm" >
                <div class="form-inputs">
                    ...
                    <div class="input-box">
                        <input type="text" class="input-field" placeholder="Nom" name="nomR" value="<?php echo $user['nomR'] ?? ''; ?>" onkeypress="allowLettersOnly(event)" >
                        <input type="text" class="input-field" placeholder="Prénom" name="prenomR" value="<?php echo $user['prenomR'] ?? ''; ?>" onkeypress="allowLettersOnly(event)" >
                    </div>
                    <div class="input-box">
                        <input type="tel" class="input-field" placeholder="Telephone" name="telephoneR" value="<?php echo $user['telephoneR'] ?? ''; ?>"  onkeypress="allowNumbersOnly(event)">
                    </div>
                    <div class="input-box">
                        <input type="date" class="input-field" placeholder="Date de naissance" name="dateR" value="<?php echo $user['dateR'] ?? ''; ?>">
                    </div> 
                    <div class="input-box">
                        <input type="email" class="input-field" placeholder="Email" name="emailR" value="<?php echo $user['emailR'] ?? ''; ?>">
                    </div>      
                    <div class="input-box">
