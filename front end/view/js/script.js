...
/*const suivant_btn = info_box.querySelector(".buttons .suivant");*/
...
function showResult(){
    ...
    if (userScore > 3){ // if user scored more than 3
        ...
        let scoreTag = '<span> et felicitaions! 🎉, vous avez eu <p>'+ userScore +'</p> out of <p>'+ questions.length +'</p></span>';
        scoreText.innerHTML = scoreTag;  //adding new span tag inside score_Text
    }
    else if(userScore > 1){ // if user scored more than 1
        let scoreTag = '<span>mais desolé😐, vous avez eu <p>'+ userScore +'</p> out of <p>'+ questions.length +'</p></span>';
...
suivantBtn.addEventListener("click", function() {
    ...
    if (userScore >= 3) {
        // If score >= 3, display an alert indicating the user passed the test
        alert("Félicitations ! Vous avez réussi le test.");
        // Redirect the user to register2.php
        ...
        // If score < 3, display an alert indicating the user failed the test
        alert("Désolé, vous n'avez pas réussi le test. Veuillez réessayer.");
        // Redirect the user back to register.php (you may need to adjust the URL)
