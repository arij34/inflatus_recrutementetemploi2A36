...
if (
    ...
    if (
        ...
        if ($_POST['domaine_informatique_test'] == 'web') {
            ...
            header("Location: /gestion%20entretien/front%20end/view/quiz.php");
            exit;
        } elseif ($_POST['domaine_informatique_test'] == 'mobile') {
            // Redirect to quiz2.php
            header("Location: /gestion%20entretien/front%20end/view/quiz2.php");
            exit;
        }  elseif ($_POST['domaine_informatique_test'] == 'data') {
            // Redirect to quiz2.php
            header("Location: /gestion%20entretien/front%20end/view/quiz3.php");
            exit;
        }  elseif ($_POST['domaine_informatique_test'] == 'security') {
            // Redirect to quiz2.php
            header("Location: /gestion%20entretien/front%20end/view/quiz4.php");
            exit;
        } else {
