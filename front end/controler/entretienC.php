...
public function updateUser2($id_entre, $email_test, $nom_entre, $prenom_entre, $nom_entreprise_test, $date_entre, $type_entre)
{
    $sql = "UPDATE entretien 
            SET email_test=:email_test, nom_entre=:nom_entre, prenom_entre=:prenom_entre, nom_entreprise_test=:nom_entreprise_test, date_entre=:date_entre, type_entre=:type_entre
