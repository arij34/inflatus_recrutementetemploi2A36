...
<body>
        ...
        <div class="content-body">
            <style>
                ...
                .form-title {
                    ...
                    margin-top: 0px; /* Added margin to move title towards the top */
                }
            ...
            <form action="" method="POST" name="myForm" onsubmit="return validateForm()">
                <div class="form-inputs">
                    <div class="input-box">
                        <input type="text" class="input-field" placeholder="Nom" name="nomE" onkeypress="allowLettersOnly(event)"  required>
                        <input type="text" class="input-field" placeholder="Prénom" name="prenomE" onkeypress="allowLettersOnly(event)"  required>
                    </div>
                    <div class="input-box">
                        <input type="tel" class="input-field" placeholder="Telephone" name="telephoneE"  onkeypress="allowNumbersOnly(event)" required>
                    </div>
                    <div class="input-box">
                        <input type="number" class="input-field" placeholder="Age" name="age" required>
                    </div> 
                    <div class="input-box">
                        <input type="email" class="input-field" placeholder="Email" name="emailE" required>
                    </div>      
                    <div class="input-box">
                        <input type="password" class="input-field" placeholder="Mot De Passe" name="MDPE" required>
                    </div>
                    <div class="input-box">
    ...
    var telephoneR = document.forms["myForm"]["telephoneE"].value;
