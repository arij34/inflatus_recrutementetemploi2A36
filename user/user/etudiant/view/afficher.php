...
<div id="preloader">
    ...
    <div class="corner-container">
        ...
        <div class="content-body">
                         <!-- Bouton "Ajouter" -->
                         <a href="../view/ajouter.php" class="btn btn-primary btn-sm btn-icon">
                                                ajouter<i class="now-ui-icons ui-1_simple-add"></i> 
                                            </a>
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                                            ...
                                            <tbody>
                                                <?php foreach ($users as $user) : ?>
                                                    <tr>
                                                        ...
                                                        <!-- Bouton "Supprimer" -->
                                                        <a href="../view/supprimer.php?idEtudiant=<?= isset($user['idEtudiant']) ? $user['idEtudiant'] : ''; ?>" class="btn btn-danger btn-sm btn-icon">
