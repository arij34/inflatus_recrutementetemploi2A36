        ...
        <div class="content-body">
            ...
            <form action="" method="POST" name="myForm" >
                <div class="form-inputs">
                    ...
                    <div class="input-box">
                        <input type="text" class="input-field" placeholder="Nom" name="nomE" value="<?php echo $user['nomE'] ?? ''; ?>" onkeypress="allowLettersOnly(event)" >
                        <input type="text" class="input-field" placeholder="Prénom" name="prenomE" value="<?php echo $user['prenomE'] ?? ''; ?>" onkeypress="allowLettersOnly(event)" >
                    </div>
                    <div class="input-box">
                        <input type="tel" class="input-field" placeholder="Telephone" name="telephoneE" value="<?php echo $user['telephoneE'] ?? ''; ?>"  onkeypress="allowNumbersOnly(event)">
                    </div>
                    <div class="input-box">
