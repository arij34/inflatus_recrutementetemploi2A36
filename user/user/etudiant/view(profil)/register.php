        ...
        if(!empty($emailE) && !empty($MDPE)) {
            ...
            if(!empty($userByEmail) && !empty($userByPassword)) {
                ...
                if(isset($userByEmail['block']) && $userByEmail['block'] == 1) {
                    ...
                    echo "<script>alert('Erreur: Votre compte est bloqué.'); window.location.href = 'http://localhost/web/etudiant/view(profil)/register.php';</script>";
                    exit();
                } else {
                ...
                echo "<script>alert('Compte non trouvé.'); window.location.href = 'http://localhost/web/etudiant/view(profil)/register.php';</script>";
                exit();
            }
        } else {
            ...
            <div class="login-form">
                <form method="post">
                    ...
                    <div class="form-inputs">
                        ...
                        <a href="http://localhost/web/etudiant/forgetPass/forget.php" class="forgot-password">Mot de passe oublié?</a>
                        <style>
