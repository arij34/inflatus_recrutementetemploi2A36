        ...
        <div class="col-12">
          <nav class="main-nav">
            ...
            <ul class="nav">
              ...
              <li class="scroll-to-section"><a href="http://localhost/web/etudiant/view(profil)/afficher.php" class="active">Profile</a></li> 

              <li class="scroll-to-section"><div class="main-red-button"><a href="http://localhost/web/etudiant/view(profil)/register.php">Se connecter</a></div></li> 
