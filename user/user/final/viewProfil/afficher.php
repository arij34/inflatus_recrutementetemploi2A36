...
if(isset($_SESSION['idR'])) {
    ...
    $telephoneR = $_SESSION['telephoneR'];
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    if (isset($_POST["modifier"])) {
        ...
        if (empty($nomR) || empty($prenomR) || empty($telephoneR) || empty($dateR) || empty($emailR) || empty($MDPR)) {
            ...
            if ($result) {
                $_SESSION['nomR'] = $nomR;
                $_SESSION['prenomR'] = $prenomR;
                $_SESSION['telephoneR'] = $telephoneR;
      ...
      <div class="row">
        <div class="col-12">
          <nav class="main-nav">
            <a href="index.html" class="logo">
              <h4>
                <div class="corner-container">
                  <img src="../view/home/templatemo_562_space_dynamic/assets/images/logo.png" >
                  <style>
                    .corner-container {
            ...
            <ul class="nav">
              <li class="scroll-to-section"><a href="../view/home/templatemo_562_space_dynamic/index.html" class="active">Home</a></li>
                ...
                <ul class="metismenu" id="menu">
                    ...
                    <li>
                        ...
                        <ul aria-expanded="false">
                            <li><a href=" dash.php">acceuil</a></li>
                    ...
                    <li>
                        ...
                        <ul aria-expanded="false">
                            <li><a href="../view/table.php" aria-expanded="false">Tableau Etudiant</a></li>
                        </ul>
                    </li>
                </ul>
            </div>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex flex-column align-items-center text-center">
                            ...
                            <div class="mt-3">
                                <h4><?php echo $nomR; ?> <?php echo $prenomR; ?></h4>
                                <p class="text-secondary mb-1">Administrateur</p>
                                
                                <a href="C:\xampp\htdocs\web\final\view\supprimer.php?idR=<?= isset($user['idR']) ? $user['idR'] : ''; ?>" class="btn btn-delete"> <i class="now-ui-icons ui-1_simple-remove"></i> Supprimer le profile</a>
                        ...
                        <form method="POST" action="">
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9 text-secondary">
                                    <input type="text" class="form-control" name="nomR" value="<?php echo $nomR; ?>">
                                </div>
                            </div>
                            <div class="row mb-3">
                                <div class="col-sm-3">
                                ...
                                <div class="col-sm-9 text-secondary">
                                    <input type="text" class="form-control" name="prenomR" value="<?php echo $prenomR; ?>">
                                </div>
                            </div>
                            <div class="row mb-3">
                                <div class="col-sm-3">
                                ...
                                <div class="col-sm-9 text-secondary">
                                    <input type="text" class="form-control" name="telephoneR" value="<?php echo $telephoneR; ?>">
                                </div>
                            </div>
                            <div class="row mb-3">
                                <div class="col-sm-3">
                                ...
                                <div class="col-sm-9 text-secondary">
                                    <input type="date" class="form-control"  name="dateR" value="<?php echo $dateR; ?>">
                                </div>
                            </div>
                            <div class="row mb-3">
                                <div class="col-sm-3">
                                ...
                                <div class="col-sm-9 text-secondary">
                                    <input type="text" class="form-control" name="emailR" value="<?php echo $emailR; ?>">
                                </div>
                            </div>
                            <div class="row mb-3">
                                <div class="col-sm-3">
                                ...
                                <div class="col-sm-9 text-secondary">
                                    <input type="text" class="form-control"  name="MDPR" value="<?php echo $MDPR; ?>">
                                </div>
                            </div>
                            <div class="row mb-3">
