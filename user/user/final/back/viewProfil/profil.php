<?php
   ...
   session_start();
    ...
    if(isset($_SESSION['idR'])) {
        ...
        header("Location: http://localhost/web/final/back/viewProfil/aff.php");
        exit;
    }
                    ...
                    <div class="card-body">
                        <div class="d-flex flex-column align-items-center text-center">
                            ...
                            <div class="mt-3">
                                ...
                                <!--a href="C:\xampp\htdocs\web\final\back\viewProfil\supprimer.php?idR=<?= isset($user['idR']) ? $user['idR'] : ''; ?>" class="btn btn-delete"> <i class="now-ui-icons ui-1_simple-remove"></i> Supprimer le profile</a-->
