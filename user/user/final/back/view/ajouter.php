<?php
    ...
    if (
        ...
        // Format the date from the form before creating the User object
        $dateRFormatted = date('Y-m-d', strtotime($_POST["dateR"]));
        $user = new User(
            null,
            $_POST["nomR"],
            $_POST["prenomR"],
            $_POST["telephoneR"],
            $dateRFormatted, // Use the formatted date here
            $_POST["emailR"],
            $_POST["MDPR"]
        );
            ...
            <form action="" method="POST" name="myForm" id="registrationForm">
                <div class="form-inputs">
                    <div class="input-box">
                        ...
                        <input type="text" class="input-field" placeholder="Telephone" name="telephoneR">
                        ...
                        <input type="text" class="input-field" placeholder="Email" name="emailR">
