...
include '../Controller/EntrepriseC.php';
    ...
    require_once "C:/xampp/htdocs/web/etudiant/forgetPass/mail/Exception.php";
    require_once "C:/xampp/htdocs/web/etudiant/forgetPass/mail/PHPMailer.php";
    require_once "C:/xampp/htdocs/web/etudiant/forgetPass/mail/SMTP.php";
    ...
    if(isset($_POST["email"])) {
        ...
        try {
            ...
            $mail->Body    = 'Voici votre lien pour modifier votre mot de passe : <a href="http://localhost/web/entreprisee/forgetPass/reset.php">Cliquez ici</a>';
            $mail->AltBody = 'Vous avez eu de problème pour charger le formulaire.';

            // Envoi de l'e-mail
            if($mail->send()) {
                // Redirection après l'envoi de l'e-mail
                header('Location:http://localhost/web/entreprisee/view(profil)/login.php');
                exit();
            } else {
