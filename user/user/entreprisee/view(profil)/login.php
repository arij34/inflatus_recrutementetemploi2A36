    ...
    if(isset($_POST['emailEn']) && isset($_POST['MDPEn'])) {
        ...
        if(!empty($emailE) && !empty($MDPE)) {
            ...
            if(!empty($userByEmail) && !empty($userByPassword)) {
                ...
                $_SESSION['MDPEn'] = $MDPE;
                header("Location: http://localhost/web/entreprisee/view(profil)/Home/templatemo_562_space_dynamic/index.html");
                exit;
            } else {
                ...
                echo '<script>                    
                     ...
                     window.location.href = "http://localhost/web/entreprisee/view(profil)/login.php";
                     </script>';
                exit();
            }
        } else {
            ...
            echo '<script> alert("Veuillez entrer votre email et mot de passe") ; window.location.href = "http://localhost/web/entreprisee/view(profil)/login.php";</script>';
            exit();
        }
    } else {
            ...
            <div class="login-form">
                <form action="login.php" method="post">
                    ...
                    <div class="form-inputs">
                        ...
                        <a href="http://localhost/web/entreprisee/forgetPass/forget.php" class="forgot-password">Mot de passe oublié?</a>
                        <style>
