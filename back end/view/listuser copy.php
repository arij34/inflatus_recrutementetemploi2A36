        ...
        <div class="nk-sidebar">  
            ...
            <div class="nk-nav-scroll">
                <ul class="metismenu" id="menu">
                    ...
                    <li>
                        <a class="has-arrow" href="javascript:void()" aria-expanded="false">
                            <i class="icon-menu menu-icon"></i><span class="nav-text">Gestion </span>
                        </a>
                        <ul aria-expanded="false">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="td-actions text-right">
                            <!-- Bouton "Modifier" -->
                            <form id="update_form_<?php echo $user['id_test']; ?>" method="POST" action="../view/updateuser.php">
                            ...
                            <!-- Bouton "Supprimer" -->
                            <a href="../view/deleteuser.php?id_test=<?php echo isset($user['id_test']) ? $user['id_test'] : ''; ?>" class="btn btn-danger btn-md btn-icon">
                                Supprimer
    ...
    if (curarray.length === 0) {
        ...
        for (var i = 0; i < curarray.length; i++) {
            ...
            newRow.innerHTML = `
                ...
                <td>
                    <form id="update_form_${curarray[i].id_test}" method="POST" action="../view/updateuser.php">
                    ...
                    <a href="../view/deleteuser.php?id_test=${curarray[i].id_test}" class="btn btn-danger btn-md btn-icon">
                        Supprimer
                        <i class="now-ui-icons ui-1_simple-remove"></i>
                    </a>
                </td>
